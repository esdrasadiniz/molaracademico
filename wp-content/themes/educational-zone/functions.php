...
function educational_zone_page_redirection() {
	global $pagenow;
		if (isset($_GET['activated']) && ('themes.php' == $pagenow) && is_admin()) {
		wp_safe_redirect(admin_url("themes.php?page=educational-zone-info.php"));
	}
}
add_action('after_setup_theme', 'educational_zone_page_redirection');
